...
source("Nimble Model JS-SCR-Dcov-SexPopDy.R")
source("Nimble Functions JS-SCR-Dcov-SexPopDy.R") #contains custom distributions and updates
...
sum(lambda.cell) #expected N in state space, total
